...
HD_PWD='/home/Emi/Documentos/NotesVault/Facu/ArquitecturaDelComputador/prueba/prueba.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Prueba.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Prueba.tcl
