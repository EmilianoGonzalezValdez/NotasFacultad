...
import qualified Basica.BasicaDoble as Ba
import qualified Basica.Comun as Escher
...
essscher ancho alto = Conf {
                basic = Es.interpBas
              , fig = Es.escher 3 Escher.Fish
              , width = ancho
              , height = alto
...
win = InWindow "Paradigmas 2025 - Lab1" (700, 700) (0, 0)
main = inicial $ return (essscher 100 100)
